...
<body>
  ...
  <div id="home"></home>
    <div class="header">
        <div id="mySidenav" class="sidenav" style="font-family: 'Times New Roman', Times, serif;">
          ...
          <img src="https://i.imgur.com/8eSTIh7.jpeg" alt="logo" class="center" width=" 330px" height="275px">
          ...
          <div id="main">
            <main tabindex ="-1" role="main" id="main-content" class="dnfkjs" style="scroll-margin-top: 152px;">
              ...
              <div id="gallery">
                <h1 style="text-decoration: underline overline goldenrod;"><em>FEATURED ARTISTS</em></h1>
                <h2 style="text-decoration: underline goldenrod;"><em>CLAUDE MONET <date>(1840-1926)</em></date></h2>
                <br><br>
                ...
                <br><br>
                <h2 style="text-decoration: underline goldenrod;"><em>MICHELANGELO  <date>(1475-1564)</em></date> </h2>
                <br><br> 
                ...
                <h2 style="text-decoration: underline overline goldenrod;"><em>THINGS TO SEE</em></h2>
                <br><br>
      ...
      <div class="event-container">
            ...
            <h3 class="year" style="color: goldenrod;"><em>>2023<</em></h3>
            <div class="event">
                <a href="#">
                <div class="event-left">
          ...
          <a href="calendar_index.php" style="background-color: goldenrod; color: purple;">Event Calendar</a>
          <br>
          <a href="TicketBooth.php" style="background-color: goldenrod; color: purple;">Ticket Booth</a>
          <br>
        </div>
      <div class="map">
        <h2 style="text-decoration: underline overline goldenrod;"><em>LOCATION</em></h2>
      ...
      <div id="address">
        <h2 style="text-decoration: underline goldenrod;"><em>Address: 2000 Simcoe St N, Oshawa, ON L1G 0C5</em></h2>
    </div>
      </div>
...
<div id="footer"></div>
      ...
      <br><br>
        ...
        <h1 style="text-decoration: underline overline goldenrod;">GALLERY HOURS</h1></ol>
        <p><em>SUNDAY:</em>     CLOSED</p>
        <p><em>MONDAY:</em>   10:30 AM-5:30 PM</p>
        <p><em>TUESDAY:</em>    10:30 AM-5:00 PM</p>
        <p><em>WEDNESDAY:</em>  10:30 AM-8:00 PM</p>
        <p><em>THURSDAY:</em>   10:30 AM-5:00 PM</p>
        <p><em>FRIDAY:</em>     10:30 AM-8:00 PM</p>
        <p><em>SATURDAY:</em>   10:30 AM-5:30 PM</p>
        </div>
        <br><br>

        <div id="end">
        <img src="https://i.imgur.com/8eSTIh7.jpeg" alt="logo" class="right"  width=" 100px" height="100px">
        <p style="color: goldenrod;"><em>Thank You for Visiting Al Sole!</em></p>
        </div>

        <br>

        <div class= "contact" style="background-color: goldenrod; color: black;">
        <footer>
